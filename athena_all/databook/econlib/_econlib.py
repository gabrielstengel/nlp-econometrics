...
class EconLibMixin:
    ...
    def findMean(self, col):
        ...
        utterance = "The mean of " + str(col).upper() + " is " + str(mean) + "."
    ...
    def findStd(self, col):
        ...
        utterance = (
            "The standard deviation of " + str(col).upper() + " is " + str(std) + "."
        )
    ...
    def findVar(self, col):
        ...
        utterance = "The variance of " + str(col).upper() + " is " + str(var) + "."
    ...
    def findMax(self, col):
        ...
        utterance = "The maximum of " + str(col).upper() + " is " + str(maximum) + "."
    ...
    def findMin(self, col):
        ...
        utterance = "The minimum of " + str(col).upper() + " is " + str(minimum) + "."
    ...
    def findMedian(self, col):
        ...
        utterance = "The median of " + str(col).upper() + " is " + str(median) + "."
    ...
    def analyze_lags(
        self, cols, time, preferred_criterion="aic", min_lag=1, max_lag=15
    ):
