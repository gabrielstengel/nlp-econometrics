    ...
    def help(self, functions=None):
        ...
        # ==================================================================================#
            ...
            if f == "largestCorrList":
                q = q + "To find the n variables most correlated with a variable, try:\n"
                q = q + "which n variables are most correlated with _var_\n\n"

            if f == "overallLargestCorrs":
                q = q + "To find the most significant correlations in the dataset, try:\n"
        ...
        # ==================================================================================#
            ...
            if f == "fixedEffects":
                ...
                q = q + " with _id_var_ as the id variable and _time_var_ as the time variable\n\n"
        ...
        # ==================================================================================#
            ...
            if f == "ivRegress":
                ...
                q = q + "run an instrumental variable regression of _dep_var_ on _ind_var_"
                q = q + " using _instrument_var_1_ and _instrument_var_2_ as instruments\n\n"

            if f == "homoskedasticJStatistic":
                q = q + "To test the exogeneity of an overidentified instrument model, try:\n"
                q = q + "in an instrumental variable regression of _dep_var_ on _ind_var_1_ and _ind_var_2_ "
                q = q + "using _instrument_var_1_ _instrument_var_2_ and _instrument_var_3_ as instruments , "
            ...
            if f == "find_instruments":
                ...
                q = q + "find the best instruments among the candidates _instrument_var_1_ "
                q = q + "_instrument_var_2_ and _instrument_var_3_ if we run _dep_var_ on _ind_var_1_ "
                q = q + "and _ind_var_2_ with _exog_var_ known to be an exogenous instrument\n\n"
        ...
        # ==================================================================================#
            ...
            if f == "print_a_bunch_of_AR_shit":
                ...
                q = q + "run an autoregression with p lags on _var_ using _time_var_ as the time variable\n\n"
                
            if f == "augmented_dicky_fuller_test":
                q = q + "To test the stationarity of a time series variable via Dickey-Fuller, try:\n"
                q = q + "test the stationarity of _var_\n\n"

            if f == "summarize_VAR":
                q = q + "To run a vector autoregression on multiple variables using p lags, try:\n"
                q = q + "run a vector autoregression on _var_1_ _var_2_ and _var_3_ with p lags "
                q = q + "using _time_var_ as the time variable\n\n"

            if f == "granger_causality_test":
                q = q + "To test whether a variable is Granger caused by other variables in a p-lag time series model, try:\n"
                q = q + "in a regression with p lags using _time_var_ as the time variable with _var_1_ _var_2_ and _var_3_ ,"
                q = q + " is _var_i_ granger caused by the others\n\n"

            if f == "analyze_lags":
                q = q + "To decide how many lags to use in a time series model, try:\n"
                q = q + "how many lags should i use on _var_1_ _var_2_ and _var_3_ with "
        ...
        # ==================================================================================#
            ...
            if f == "choose_among_regression_models":
                q = q + "To choose from among a set of models by estimating out of sample generalizability "
                q = q + "using a penalty term system, try:\n"
                q = q + "which of the following models has the best out of sample generalizability : "
                q = q + "_var_1_ , _var_2_ , and _var_3_ ; _var_4_ , _var_5_ , and _var_6_ ; "
