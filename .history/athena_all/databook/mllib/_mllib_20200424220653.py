...
class EconLibMixin:
    ...
    def analyze_lags(self, cols, time, preferred_criterion="aic", min_lag=1, max_lag=3):
        ...
        return [
            ...
            (
                [
                    ...
                    "find the best instrumental variables",
            ...
            # ==================== Advanced Regression Methods =========================#
            (
                ["principle", "component", "analysis", "pca", "eigenvalue decomposition"],
                "print_PCA_wrapper",
                self.print_PCA_wrapper,
            ),
            (
                ["poisson", "poisson regression", "poisson regress", "distributed poisson", "poisson reg"],
                "poisson_regression",
            ...
            (
                ["best model", "which model is", "criterion", "best", "optimal", "most accurate", "regression model", "regressive model"],
