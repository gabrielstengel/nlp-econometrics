...
@click.command()
@click.argument('print_all_examples', default=True, help="True if you want all examples to be printer with parses, false if you only want unparsed examples to be printed.")
@click.argument('function_names', nargs = -1, default='all', help="Functions you would like to parse.")
def main(print_all_examples, function_names):
    ...
    if function_names == 'all':
        ...
        for func in sys.argv[2:]:
            examples += get_examples_by_func(func)
