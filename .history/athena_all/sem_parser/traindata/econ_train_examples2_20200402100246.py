...
train_examples =  [
    ...
    Example(input="regress column_y on EASY, MATIC, ENTERQ, YEAR, ANIMAL", semantics=('multiReg', 'column_y', dep_vars_4), to_lower=True, denotation=multi_reg_5),
    ...
    Example(input="regress GDP on BEDWARDS, TANK, and DUMMY", semantics=('multiReg', 'dgp', dep_vars_2), to_lower=True, denotation=multi_reg_2),
...
def get_ivRegrerss_examples(num='all'):
    if num == 'all':
        return [ex for ex in train_examples if ex.semantics[0] == 'ivRegress']
