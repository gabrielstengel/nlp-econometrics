...
class trainingExamples:
    ...
    def get_train_examples(self):
        ...
        logit_reg_1 = db.summarizeLogisticRegression("dummy", dep_vars_1).summary()
        logit_reg_2 = db.summarizeLogisticRegression("dummy", dep_vars_2).summary()
        logit_reg_3 = db.summarizeLogisticRegression("dummy", dep_vars_3).summary()
        logit_reg_4 = db.summarizeLogisticRegression("dummy", dep_vars_4).summary()
