...
train_examples =  [
    ...
    #sExample(input="Run linear regression of column_x on GDP, EASY, AUTO, and MATIC.", semantics=('multiReg', 'column_x', dep_vars_3), to_lower=True, denotation=multi_reg_4),
