...
train_examples =  [
    ...
    Example(input="What is the mean of AGE", semantics=('findMean', ('get_col', 'AGE')), to_lower=True, denotation=0.5918052762222222),
    Example(input="Find the average of ENTERQ", semantics=('findMean', ('get_col', 'ENTERQ')), to_lower=True, denotation=0.4654046005555556),
    Example(input="What is the average of AGE", semantics=('findMean', ('get_col', 'AGE')), to_lower=True, denotation=0.5918052762222222),
    Example(input="Find the avg of ENTERQ", semantics=('findMean', ('get_col', 'ENTERQ')), to_lower=True, denotation=0.4654046005555556),
    Example(input="What is the avg of AGE", semantics=('findMean', ('get_col', 'AGE')), to_lower=True, denotation=0.5918052762222222),
    ...
    Example(input="mean of AGE", semantics=('findMean', ('get_col', 'AGE')), to_lower=True, denotation=0.5918052762222222),
    Example(input="Find the average of ENTERQ", semantics=('findMean', ('get_col', 'ENTERQ')), to_lower=True, denotation=0.4654046005555556),
    Example(input="Whats the average of AGE", semantics=('findMean', ('get_col', 'AGE')), to_lower=True, denotation=0.5918052762222222),
    Example(input="What's the mean of AGE", semantics=('findMean', ('get_col', 'AGE')), to_lower=True, denotation=0.5918052762222222),
    Example(input="average of ENTERQ", semantics=('findMean', ('get_col', 'ENTERQ')), to_lower=True, denotation=0.4654046005555556),
    Example(input="average AGE", semantics=('findMean', ('get_col', 'AGE')), to_lower=True, denotation=0.5918052762222222),
    Example(input="AGE's mean", semantics=('findMean', ('get_col', 'AGE')), to_lower=True, denotation=0.5918052762222222),
    Example(input="AGEs mean", semantics=('findMean', ('get_col', 'AGE')), to_lower=True, denotation=0.5918052762222222),
    Example(input="AGE's average", semantics=('findMean', ('get_col', 'AGE')), to_lower=True, denotation=0.5918052762222222),
    Example(input="Show AGE's mean", semantics=('findMean', ('get_col', 'AGE')), to_lower=True, denotation=0.5918052762222222),
    Example(input="Find AGEs mean", semantics=('findMean', ('get_col', 'AGE')), to_lower=True, denotation=0.5918052762222222),
    Example(input="What is AGE's average", semantics=('findMean', ('get_col', 'AGE')), to_lower=True, denotation=0.5918052762222222),
