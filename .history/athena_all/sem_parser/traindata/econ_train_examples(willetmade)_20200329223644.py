...
the_five = [['enterq', 'dummy'], ['tank', 'person_id'], ['yeah', 'person_id'], ['bedwards', 'enterq'], ['yeah', 'tank']]
the_three = [['enterq', 'dummy'], ['yeah', 'person_id'], ['bedwards', 'enterq']]
the_four = [['enterq', 'dummy'], ['tank', 'person_id'], ['yeah', 'person_id'], ['bedwards', 'enterq']]
the_six = [['enterq', 'dummy'], ['tank', 'person_id'], ['yeah', 'person_id'], ['bedwards', 'enterq'], ['bedwards', 'tank'], ['yeah', 'tank']]
...
dep_vars_4 = np.array(['easy', 'matic', 'enterq', 'yeah', 'animal'])
...
instruments_3 = np.array(['stinger', 'person_id', 'dummy', 'yeah', 'AGE'])
instruments_4 = np.array(['GDP', 'PANEL_yeah', 'dummy', 'beast', 'tank', 'stinger'])
