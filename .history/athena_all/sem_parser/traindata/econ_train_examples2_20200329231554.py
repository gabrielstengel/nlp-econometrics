...
train_examples =  [
    ...
    Example(input="Find the mean of ENTERQ", semantics=('findMean', ('get_col', 'ENTERQ')), to_lower=True, denotation=0.4654046005555556s),
    Example(input="What is the mean of AGE", semantics=('findMean', ('get_col', 'AGE')), to_lower=True, denotation=0.5918052761111111),
    Example(input="Find the average of ENTERQ", semantics=('findMean', ('get_col', 'ENTERQ')), to_lower=True, denotation=0.4654046005555556s),
    Example(input="What is the average of AGE", semantics=('findMean', ('get_col', 'AGE')), to_lower=True, denotation=0.5918052761111111),
    Example(input="Find the avg of ENTERQ", semantics=('findMean', ('get_col', 'ENTERQ')), to_lower=True, denotation=0.4654046005555556s),
    ...
    Example(input="Show mean of ENTERQ", semantics=('findMean', ('get_col', 'ENTERQ')), to_lower=True, denotation=0.4654046005555556s),
    ...
    Example(input="average of ENTERQ", semantics=('findMean', ('get_col', 'ENTERQ')), to_lower=True, denotation=0.4654046005555556s),
