...
def get_ivRegrerss_examples(num='all'):
    ...
    return [ex for ex in get_train_examples() if ex.semantics[0] == 'ivRegress'][:num]

def get_examples_by_func(func, num='all'):
    if num == 'all':
        return [ex for ex in get_train_examples() if ex.semantics[0] == func]
    return [ex for ex in get_train_examples() if ex.semantics[0] == func][:num]

def get_multiReg_examples(num='all'):
    if num == 'all':
        return [ex for ex in get_train_examples() if ex.semantics[0] == 'multiReg']
    return [ex for ex in get_train_examples() if ex.semantics[0] == 'multiReg'][:num]

def get_largestCorr_examples(num='all'):
    if num == 'all':
        return [ex for ex in get_train_examples() if ex.semantics[0] == 'largestCorr']
    return [ex for ex in get_train_examples() if ex.semantics[0] == 'largestCorr'][:num]
