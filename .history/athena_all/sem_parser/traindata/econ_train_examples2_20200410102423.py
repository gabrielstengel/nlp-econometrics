...
class trainingExamples:
    ...
    def get_train_examples(self, ignore_denotation=False):
        db = DataBook()
        db.add_df(self.train_example_matrix())
        
        if not ignore_denotation: 
            the_five = [
                ["enterq", "dummy"],
                ["tank", "person_id"],
                ["year", "person_id"],
        ...
        denoted_examples = [
            ...
            Example(
                input="With year as the time index, run an autoregression with the variables easy, matic, enterq, year, and animal with 2 lags.",
            ...
            Example(
                input="Run an vector time series regression with year as the time variable with the columns easy, matic, enterq, year, and animal with 2 lags.",
                semantics=("summarize_VAR", dep_vars_4, "year", 4),
                to_lower=True,
                denotation=summarize_VAR_4,
            ),
