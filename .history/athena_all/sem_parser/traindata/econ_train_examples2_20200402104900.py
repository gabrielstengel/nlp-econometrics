...
train_examples =  [
    ...
    Example(input="Graph stinger versus column_y for me please.", semantics=('graph', 'args'), to_lower=True, denotation=0),
    Example(input="run an OLS regression of stinger on column_z", semantics=('reg', 'stinger', 'column_y'), to_lower=True, denotation=0),
