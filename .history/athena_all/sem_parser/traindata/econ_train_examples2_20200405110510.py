...
class trainingExamples:
    ...
    def get_train_examples(self):
        ...
        summarize_VAR_4 = db.summarize_VAR(dep_vars_4, "year", 4).denotation

        granger_causality_test_1 = db.granger_causality_test(dep_vars_1, "year", 3, "stinger", ["matic", "beast"]).denotation
        granger_causality_test_2 = db.granger_causality_test(dep_vars_2, "year", 3, "bedwards", ["dummy", "tank"]).denotation
        granger_causality_test_3 = db.granger_causality_test(dep_vars_3, "year", 3, "gdp", ["easy", "auto", "matic"]).denotation
        ...
        denoted_examples = [
            ...
            Example(
                ...
                semantics=("find_instruments", "tank", "enterq", "bedwards", dep_vars_1),
                to_lower=True,
                denotation=find_instruments_1,
            ),
            Example(
                ...
                semantics=("find_instruments", "beast", "enterq", "stinger", dep_vars_2),
                to_lower=True,
                denotation=find_instruments_2,
            ),
            Example(
                ...
                semantics=("find_instruments", "bedwards", "enterq", "stinger", dep_vars_3),
                to_lower=True,
                denotation=find_instruments_3,
            ),
            ...
            Example(
                input="Run a three-lag vector autoregression with the variables stinger, matic, and beast, please.",
                semantics=("summarize_VAR", dep_vars_1, "year", 3),
                to_lower=True,
                denotation=summarize_VAR_1,
            ),
            Example(
                input="Can you run a general 2-lag multivariate autoregression with the variables bedwards, tank, and matic?",
                semantics=("summarize_VAR", dep_vars_2, "year", 2),
                to_lower=True,
                denotation=summarize_VAR_2,
            ),
            Example(
                input="Run VAR with the variables bedwards, tank, and matic, with 2 lags.",
                semantics=("summarize_VAR", dep_vars_3, "year", 2),
                to_lower=True,
                denotation=summarize_VAR_3,
            ),
            Example(
                input="Run an autoregression with the variables easy, matic, enterq, year, and animal with 2 lags.",
                semantics=("summarize_VAR", dep_vars_4, "year", 4),
                to_lower=True,
                denotation=summarize_VAR_4,
            ),
            Example(
                input="VAR with 3 lags with the variables stinger, matic, and beast, please.",
                semantics=("summarize_VAR", dep_vars_1, "year", 3),
                to_lower=True,
                denotation=summarize_VAR_1,
            ),
            Example(
                input="Two lag multivariate autoregression with the variables bedwards, tank, and matic?",
                semantics=("summarize_VAR", dep_vars_2, "year", 2),
                to_lower=True,
                denotation=summarize_VAR_2,
            ),
            Example(
                input="Using bedwards, tank, and matic, run VAR with 2 lags.",
                semantics=("summarize_VAR", dep_vars_3, "year", 2),
                to_lower=True,
                denotation=summarize_VAR_3,
            ),
            Example(
                input="Run an vector time series regression with the columns easy, matic, enterq, year, and animal with 2 lags.",
                semantics=("summarize_VAR", dep_vars_4, "year", 4),
                to_lower=True,
                denotation=summarize_VAR_4,
            ),
            ...
            Example(
                ...
                semantics=("granger_causality_test", dep_vars_1, "year", 3, "stinger", ["matic", "beast"]),
                to_lower=True,
            ...
            Example(
                ...
                semantics=("granger_causality_test", dep_vars_2, "year", 3, "bedwards", ["dummy", "tank"]),
                to_lower=True,
            ...
            Example(
                ...
                semantics=("granger_causality_test", dep_vars_3, "year", 3, "gdp", ["easy", "auto", "matic"]),
                to_lower=True,
            ...
            Example(
                ...
                semantics=("analyze_lags", dep_vars_2, "year", 1, 3),
                to_lower=True,
