...
db = DataBook()
db.addSheet(train_example_matrix())
...
reg_GDP_STINGER = reg('GDP', 'STINGER')
reg_BEAST_MATIC = reg('BEAST', 'MATIC')
reg_TANK_BEDWARDS = reg('TANK', 'BEDWARDS')
...
multi_reg_1 = multiReg('GDP', dep_vars_1)
multi_reg_2 = multiReg('GDP', dep_vars_2)
multi_reg_3 = multiReg('STINGER', dep_vars_3)
multi_reg_4 = multiReg('ANIMAL', dep_vars_3)

multi_reg_5 = multiReg('BEDWARDS', dep_vars_4)
multi_reg_6 = multiReg('AUTO', dep_vars_4)
...
iv_fit_1 = ivRegress('BEDWARDS', dep_vars_1, instruments_1)
iv_fit_2 = ivRegress('GDP', dep_vars_2, instruments_2)
iv_fit_3 = ivRegress('BEAST', dep_vars_3, instruments_3)
iv_fit_4 = ivRegress('AGE', dep_vars_4, instruments_4)
