...
reg_GDP_STINGER = db.reg('gdp', 'stinger')
reg_BEAST_MATIC = db.reg('beast', 'matic')
reg_TANK_BEDWARDS = db.reg('tank', 'bedwards')
...
multi_reg_1 = db.multiReg('gdp', dep_vars_1)
multi_reg_2 = db.multiReg('gdp', dep_vars_2)
multi_reg_3 = db.multiReg('stinger', dep_vars_3)
multi_reg_4 = db.multiReg('animal', dep_vars_3)

multi_reg_5 = db.multiReg('bedwards', dep_vars_4)
multi_reg_6 = db.multiReg('auto', dep_vars_4)
...
train_examples =  [
    ...
    Example(input="Graph column_x versus column_y for me please.", semantics=('graph', 'args'), to_lower=True, denotation=0),
    Example(input="run an OLS regression of column_x on column_z", semantics=('reg', 'column_x', 'column_y'), to_lower=True, denotation=0),
    Example(input="Which five cols are most correlated with column_x", semantics=('largestCorrList', 'column_x', 5), to_lower=True, denotation=0),
    Example(input="Which of the columns has the largest correlation with column_xyz", semantics=('largestCorr', 'BEDWARDS'), to_lower=True, denotation=0),
    Example(input="Show the three biggest values of column_z.", semantics=('summarize'), to_lower=True, denotation=0),
    Example(input="Calculate the variance of column_z, please.", semantics=('findVar', ('get_col', 'column_z')), to_lower=True, denotation=0),
    Example(input="regress column_y on EASY, MATIC, ENTER1, YEAR, ANIMAL", semantics=('multiReg', 'column_y', dep_vars_4), to_lower=True, denotation=multi_reg_5),
    Example(input="Run linear regression of column_x on GDP, EASY, AUTO, and MATIC.", semantics=('multiReg', 'column_x', dep_vars_3), to_lower=True, denotation=multi_reg_4),
    ...
    Example(input="Find the mean of ENTERQ", semantics=('findMean', ('get_col', 'ENTERQ')), to_lower=True, denotation=0.4654046005555556),
    Example(input="What is the mean of AGE", semantics=('findMean', ('get_col', 'AGE')), to_lower=True, denotation=0.5918052761111111),
    Example(input="Find the average of ENTERQ", semantics=('findMean', ('get_col', 'ENTERQ')), to_lower=True, denotation=0.4654046005555556),
    Example(input="What is the average of AGE", semantics=('findMean', ('get_col', 'AGE')), to_lower=True, denotation=0.5918052761111111),
    Example(input="Find the avg of ENTERQ", semantics=('findMean', ('get_col', 'ENTERQ')), to_lower=True, denotation=0.4654046005555556),
    Example(input="What is the avg of AGE", semantics=('findMean', ('get_col', 'AGE')), to_lower=True, denotation=0.5918052761111111),

    # findMean: improper grammar
    Example(input="Show mean of ENTERQ", semantics=('findMean', ('get_col', 'ENTERQ')), to_lower=True, denotation=0.4654046005555556),
    Example(input="mean of AGE", semantics=('findMean', ('get_col', 'AGE')), to_lower=True, denotation=0.5918052761111111),
    Example(input="Find the average of ENTERQ", semantics=('findMean', ('get_col', 'ENTERQ')), to_lower=True, denotation=0.4654046005555556),
    Example(input="Whats the average of AGE", semantics=('findMean', ('get_col', 'AGE')), to_lower=True, denotation=0.5918052761111111),
    Example(input="What's the mean of AGE", semantics=('findMean', ('get_col', 'AGE')), to_lower=True, denotation=0.5918052761111111),
    Example(input="average of ENTERQ", semantics=('findMean', ('get_col', 'ENTERQ')), to_lower=True, denotation=0.4654046005555556),
    Example(input="average AGE", semantics=('findMean', ('get_col', 'AGE')), to_lower=True, denotation=0.5918052761111111),
    Example(input="AGE's mean", semantics=('findMean', ('get_col', 'AGE')), to_lower=True, denotation=0.5918052761111111),
    Example(input="AGEs mean", semantics=('findMean', ('get_col', 'AGE')), to_lower=True, denotation=0.5918052761111111),
    Example(input="AGE's average", semantics=('findMean', ('get_col', 'AGE')), to_lower=True, denotation=0.5918052761111111),
    Example(input="Show AGE's mean", semantics=('findMean', ('get_col', 'AGE')), to_lower=True, denotation=0.5918052761111111),
    Example(input="Find AGEs mean", semantics=('findMean', ('get_col', 'AGE')), to_lower=True, denotation=0.5918052761111111),
    Example(input="What is AGE's average", semantics=('findMean', ('get_col', 'AGE')), to_lower=True, denotation=0.5918052761111111),

    # --------------------------------------------------------------------------------------------------------------- #
    # findStd: proper gramamr
    Example(input="Find the std of ENTERQ", semantics=('findStd', ('get_col', 'ENTERQ')), to_lower=True, denotation=0.317088313970524),
    Example(input="What is the standard deviation of AGE", semantics=('findStd', ('get_col', 'AGE')), to_lower=True, denotation=0.24739176853948733),
    Example(input="Find the standard deviation of ENTERQ", semantics=('findStd', ('get_col', 'ENTERQ')), to_lower=True, denotation=0.317088313970524),
    Example(input="What is the std of AGE", semantics=('findStd', ('get_col', 'AGE')), to_lower=True, denotation=0.24739176853948733),
    Example(input="Find the std of ENTERQ", semantics=('findStd', ('get_col', 'ENTERQ')), to_lower=True, denotation=0.317088313970524),
    Example(input="What is the standard dev of AGE", semantics=('findStd', ('get_col', 'AGE')), to_lower=True, denotation=0.24739176853948733),

    # findStd: improper grammar
    Example(input="Show standard deviation of ENTERQ", semantics=('findStd', ('get_col', 'ENTERQ')), to_lower=True, denotation=0.317088313970524),
    Example(input="std of AGE", semantics=('findStd', ('get_col', 'AGE')), to_lower=True, denotation=0.24739176853948733),
    Example(input="Find the std of ENTERQ", semantics=('findStd', ('get_col', 'ENTERQ')), to_lower=True, denotation=0.317088313970524),
    Example(input="Whats the std deviation of AGE", semantics=('findStd', ('get_col', 'AGE')), to_lower=True, denotation=0.24739176853948733),
    Example(input="What's the stddev of AGE", semantics=('findStd', ('get_col', 'AGE')), to_lower=True, denotation=0.24739176853948733),
    Example(input="standard deviation of ENTERQ", semantics=('findStd', ('get_col', 'ENTERQ')), to_lower=True, denotation=0.317088313970524),
    Example(input="standard deviation AGE", semantics=('findStd', ('get_col', 'AGE')), to_lower=True, denotation=0.24739176853948733),
    Example(input="AGE's stddev", semantics=('findStd', ('get_col', 'AGE')), to_lower=True, denotation=0.24739176853948733),
    Example(input="AGEs stddev", semantics=('findStd', ('get_col', 'AGE')), to_lower=True, denotation=0.24739176853948733),
    Example(input="AGE's standard deviation", semantics=('findStd', ('get_col', 'AGE')), to_lower=True, denotation=0.24739176853948733),
    Example(input="Show AGE's stddev", semantics=('findStd', ('get_col', 'AGE')), to_lower=True, denotation=0.24739176853948733),
    Example(input="Find AGEs stddev", semantics=('findStd', ('get_col', 'AGE')), to_lower=True, denotation=0.24739176853948733),
    Example(input="What is AGE's standard deviation", semantics=('findStd', ('get_col', 'AGE')), to_lower=True, denotation=0.24739176853948733),

    # --------------------------------------------------------------------------------------------------------------- #
    # findVar: proper grammar
    Example(input="Find the var of ENTERQ", semantics=('findVar', ('get_col', 'ENTERQ')), to_lower=True, denotation=0.10054499885666962),
    Example(input="What is the variance of AGE", semantics=('findVar', ('get_col', 'AGE')), to_lower=True, denotation=0.06120268714109527),
    Example(input="Find the spread of ENTERQ", semantics=('findVar', ('get_col', 'ENTERQ')), to_lower=True, denotation=0.10054499885666962),
    Example(input="What is the var of AGE", semantics=('findVar', ('get_col', 'AGE')), to_lower=True, denotation=0.06120268714109527),
    Example(input="Find the variance of ENTERQ", semantics=('findVar', ('get_col', 'ENTERQ')), to_lower=True, denotation=0.10054499885666962),
    Example(input="What is the var of AGE", semantics=('findVar', ('get_col', 'AGE')), to_lower=True, denotation=0.06120268714109527),

    # --------------------------------------------------------------------------------------------------------------- #
    # findMax: proper grammar
    Example(input="Find the max of ENTERQ", semantics=('findMax', ('get_col', 'ENTERQ')), to_lower=True, denotation=0.95031834),
    Example(input="What is the max of AGE", semantics=('findMax', ('get_col', 'AGE')), to_lower=True, denotation=0.9249519),
    Example(input="Find the max value in ENTERQ", semantics=('findMax', ('get_col', 'ENTERQ')), to_lower=True, denotation=0.95031834),
    Example(input="What is the biggest value in AGE", semantics=('findMax', ('get_col', 'AGE')), to_lower=True, denotation=0.9249519),
    Example(input="Find the largest ENTERQ value", semantics=('findMax', ('get_col', 'ENTERQ')), to_lower=True, denotation=0.95031834),
    Example(input="What is the biggest entry in AGE", semantics=('findMax', ('get_col', 'AGE')), to_lower=True, denotation=0.9249519),

    # --------------------------------------------------------------------------------------------------------------- #
    # findMin: proper grammar
    Example(input="Find the min of ENTERQ", semantics=('findMin', ('get_col', 'ENTERQ')), to_lower=True, denotation=0.0038075),
    Example(input="What is the min of AGE", semantics=('findMin', ('get_col', 'AGE')), to_lower=True, denotation=0.0548202),
    Example(input="Find the min value in ENTERQ", semantics=('findMin', ('get_col', 'ENTERQ')), to_lower=True, denotation=0.0038075),
    Example(input="What is the smallest value in AGE", semantics=('findMin', ('get_col', 'AGE')), to_lower=True, denotation=0.0548202),
    Example(input="Find the smallest ENTERQ value", semantics=('findMin', ('get_col', 'ENTERQ')), to_lower=True, denotation=0.0038075),
    Example(input="What is the smallest entry in AGE", semantics=('findMin', ('get_col', 'AGE')), to_lower=True, denotation=0.0548202),

    # --------------------------------------------------------------------------------------------------------------- #
    # findMedian: proper grammar
    Example(input="Find the median of ENTERQ", semantics=('findMedian', ('get_col', 'ENTERQ')), to_lower=True, denotation=0.419915855),
    Example(input="What is the median of AGE", semantics=('findMedian', ('get_col', 'AGE')), to_lower=True, denotation=0.6287337550000001),
    Example(input="Find the median value in ENTERQ", semantics=('findMedian', ('get_col', 'ENTERQ')), to_lower=True, denotation=0.419915855),
    Example(input="What is the middle value in AGE", semantics=('findMedian', ('get_col', 'AGE')), to_lower=True, denotation=0.6287337550000001),
    Example(input="Find the middle ENTERQ value", semantics=('findMedian', ('get_col', 'ENTERQ')), to_lower=True, denotation=0.419915855),
    Example(input="What is the median entry in AGE", semantics=('findMedian', ('get_col', 'AGE')), to_lower=True, denotation=0.6287337550000001),
