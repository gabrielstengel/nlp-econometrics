...
def evaluate_model(
    ...
    for example in examples:
        ...
        if print_examples and print_test(test_metric.evaluate(example, parses)):
...
def evaluate_for_domain(domain, print_examples=True, only_false_examples=True):
    print("#" * 80)
    ...
    which_examples = "ONLY PRINTING UN-PARSED EXAMPLES." if only_false_examples else "PRINTING ALL EXAMPLESS."
    print("#" * 80)
