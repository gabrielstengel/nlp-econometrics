...
from athena_all.sem_parser.metrics import SemanticsAccuracyMetric, NumParsesMetric, standard_metrics
from athena_all.sem_parser.grammar.example import Example
from athena_all.sem_parser.grammar.learning import latent_sgd
#from athena_all.sem_parser.grammar import is_cat, parse_to_pretty_string, print_grammar
from athena_all.sem_parser.grammar import Parse
from athena_all.sem_parser.grammar._rule import is_cat
from athena_all.sem_parser.grammar.scoring import Model, rule_features
...
def print_parses(example,
        ...
        for idx, parse in enumerate(parses[:max_parses]):
            ...
            lines = []
            if show_syntax:
                lines.append('%-15s %s   \n%s' % ('parse', parse_outcome, parse.parse_to_pretty_string()))
