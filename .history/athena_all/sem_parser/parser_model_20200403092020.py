...
from athena_all.sem_parser.traindata.econ_train_examples2 import (
    ...
    train_examples,
    get_ivRegrerss_examples,
    get_multiReg_examples,
)
...
class EconometricSemanticParser(Domain):
    ...
    def train_examples(self):s
        return get_multiReg_examples()[:1]  # + create_examples_from_amt()

    def test_examples(self):
        return get_multiReg_examples()[:1]
