...
@click.command()
@click.argument('print_all_examples', default=True)
@click.argument('function_names', nargs = -1, default='all')
...
if __name__ == "__main__":
    ...
    print_all = True if len(sys.argv) < 2 else (sys.argv[1].lower() == "true")
    ...
    evaluate_for_domain(domain, print_examples=True, print_all=print_all)
