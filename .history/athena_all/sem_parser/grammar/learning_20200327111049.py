...
from athena_all.sem_parser.metrics import SemanticsAccuracyMetric, DenotationAccuracyMetric
from athena_all.sem_parser.grammar.scoring import Model, score
...
def _update_weights(model, target_parse, predicted_parse, eta, l2_penalty, adagrad, ada_update_mag):
